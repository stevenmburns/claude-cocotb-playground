module moore_stage_array #(
    ...
    // Unpacked arrays: each element is a full wire, avoiding part-select
    // connections with output reg ports from moore_stage.
    wire             mid_v [0:N];
    wire             mid_r [0:N];
