...
//   3 transactions: a[7:0], a[15:8], a[23:16]  (LSB first, one byte per SS_N assert)
//   3 transactions: b[7:0], b[15:8], b[23:16]
//   Poll result_ready; when high:
//   3 transactions: dummy → MISO = r[7:0], r[15:8], r[23:16]  (LSB first)
//
...
module spi_gcd_top (
    ...
    localparam WAIT_SS      = 4'd6;   // wait for SS_N to deassert after last RX byte
